...
> **Nota del Traductor:** Esta es una traducción al español de la guía "[Linux Kernel `sysctl` Hardening](linux-kernel-sysctl-hardening.md)". Se mantienen términos técnicos en inglés siguiendo convenciones de la industria.
...
Esta es una lista combinada de todas las recomendaciones de hardening con `sysctl` que pude encontrar en múltiples sitios:
...
La documentación para **la mayoría** de estas claves se puede encontrar en https://github.com/torvalds/linux/blob/master/Documentation. Sin embargo, la documentación parece ser para el kernel 2.2. No puedo encontrar documentación más reciente. Si sabes dónde puedo encontrar documentación más nueva, por favor envía un [nuevo issue](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server/issues/new).

## Descargo de Responsabilidad

No sé qué hacen la mayoría de estas configuraciones. Esta lista se proporciona solo como material de referencia. No me hago responsable de nada.
